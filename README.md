...
| `master.xlsx` | **Active Excel template** — contains official roster and styling. Used as clean source of truth roster |
| `HV_Mau 2_Tong hop KQRL cua SV.xlsx` | *(Generated)* Final summarized Excel roster generated by the pipeline |
...
* **Mathematical Consistency**: Category totals and grand totals are verified and overwritten from the master Excel template ([master.xlsx](master.xlsx)).
...
- Reads the official student roster from `master.xlsx`.
