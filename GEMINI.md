...
5. the pipeline script is process_and_generate.py — run it with python3 process_and_generate.py to regenerate all 37 student files, the static charts, and the HTML dashboard
